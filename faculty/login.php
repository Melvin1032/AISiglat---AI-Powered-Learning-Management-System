...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("SELECT id, username, password, role FROM users WHERE username = ? AND role = 'faculty'");
...
<head>
    ...
    <title>Faculty Login - SmartLMS</title>
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                ...
                <p>Access your instructor dashboard</p>
            </div>
            ...
            <form method="POST">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-sign-in-alt"></i> Login to Faculty Dashboard
                </button>
            </form>
